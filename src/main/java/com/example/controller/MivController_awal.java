...
import com.example.service.MivlService;
...
public class MivController_awal extends HttpServlet {
    private MivlService service;
    private static final Logger logger = LoggerUtil.getLogger(MivController_awal.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            service = new MivlService(dbService.getDataSource());
        } catch (Exception e) {
