        ...
        try (Connection conn = dataSource.getConnection();
            ...
            try (ResultSet rs = (ResultSet) stmt.getObject(9)) {
                ...
                while (rs.next()) {
                    ...
                    row.put("URUT", rs.getString("URUT"));
                    row.put("PRODUK", rs.getString("PRODUK"));
                    row.put("TGLAPPROVE", rs.getString("TGLAPPROVE"));
                    row.put("KD_DIST", rs.getString("KD_DIST"));
                    row.put("VA", rs.getString("VA"));
                    row.put("SATKER", rs.getString("SATKER"));
                    row.put("PLN_NOUSULAN", rs.getString("PLN_NOUSULAN"));
                    row.put("PLN_KDPROSES", rs.getString("PLN_KDPROSES"));
                    row.put("PLN_STATUS", rs.getString("PLN_STATUS"));
                    row.put("PLN_IDPEL", rs.getString("PLN_IDPEL"));
                    row.put("PLN_BLTH", rs.getString("PLN_BLTH"));
                    row.put("PLN_LUNAS_H0", rs.getString("PLN_LUNAS_H0"));
                    row.put("PLN_RPTAG", rs.getString("PLN_RPTAG"));
                    row.put("PLN_RPBK", rs.getString("PLN_RPBK"));
                    row.put("PLN_TGLBAYAR", rs.getString("PLN_TGLBAYAR"));
                    row.put("PLN_JAMBAYAR", rs.getString("PLN_JAMBAYAR"));
                    row.put("PLN_USERID", rs.getString("PLN_USERID"));
                    row.put("PLN_KDBANK", rs.getString("PLN_KDBANK"));
                    ...
                    row.put("SELISIH_RPTAG", rs.getString("SELISIH_RPTAG"));
                    row.put("SELISIH_BK", rs.getString("SELISIH_BK"));
