...
public class MivServiceTest {
    private static final Logger logger = LoggerUtil.getLogger(MivServiceTest.class);

    public static void main(String[] args) {
        Properties props = new Properties();

        try (InputStream input = MivServiceTest.class.getClassLoader().getResourceAsStream("db.properties")) {
            if (input == null) {
        ...
        try {
            ...
            MivlService service = new MivlService(ods);
