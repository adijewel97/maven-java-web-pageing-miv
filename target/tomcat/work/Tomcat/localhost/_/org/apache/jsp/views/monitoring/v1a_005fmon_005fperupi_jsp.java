 ...
 * Generated at: 2025-07-09 07:34:29 UTC
...
public final class v1a_005fmon_005fperupi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <div class=\"mb-2\">\r\n");
      out.write("                <button id=\"btnExportMonRkpAllExcel\" class=\"btn btn-success btn-export\">\r\n");
      ...
      out.write("                    title: 'MIV_REKAP_' + convertBulanTahunToYYYYMM($('#bln_usulan').val()),\r\n");
      out.write("                    className: 'd-none', // tombol disembunyikan\r\n");
      ...
      out.write("                        const timestamp = \"Tanggal Download: \"+dd+\"/\"+mm+\"/\"+yyyy+\" \"+hh+\":\"+mi+\":\"+ss;\r\n");
      out.write("                        const judul = \"MIV_REKAP_\" + convertBulanTahunToYYYYMM($('#bln_usulan').val());\r\n");
      out.write("\r\n");
      out.write("                        // Geser semua baris ke bawah 2\r\n");
      out.write("                        // $('row', sheetData).each(function () {\r\n");
      out.write("                        //     const r = parseInt($(this).attr('r'));\r\n");
      out.write("                        //     const newR = r + 2;\r\n");
      out.write("                        //     $(this).attr('r', newR);\r\n");
      out.write("                        //     $(this).find('c').each(function () {\r\n");
      out.write("                        //         const cellRef = $(this).attr('r');\r\n");
      out.write("                        //         if (cellRef) {\r\n");
      out.write("                        //             const col = cellRef.replace(/[0-9]/g, '');\r\n");
      out.write("                        //             $(this).attr('r', col + newR);\r\n");
      out.write("                        //         }\r\n");
      out.write("                        //     });\r\n");
      out.write("                        // });\r\n");
      out.write("\r\n");
      out.write("                        // // Tambahkan baris A1 dan A2 (tanpa merge)\r\n");
      out.write("                        // const row1 = `\r\n");
      out.write("                        //     <row r=\"1\">\r\n");
      out.write("                        //         <c t=\"inlineStr\" r=\"A1\">\r\n");
      out.write("                        //             <is><t>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${judul}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("</t></is>\r\n");
      out.write("                        //         </c>\r\n");
      out.write("                        //     </row>\r\n");
      out.write("                        // `;\r\n");
      out.write("                        // const row2 = `\r\n");
      out.write("                        //     <row r=\"2\">\r\n");
      out.write("                        //         <c t=\"inlineStr\" r=\"A2\">\r\n");
      out.write("                        //             <is><t>");
      ...
      out.write("                        // `;\r\n");
      out.write("\r\n");
      out.write("                        // // Sisipkan ke atas\r\n");
      out.write("                        // sheetData.prepend(row2);\r\n");
      out.write("                        // sheetData.prepend(row1);\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            ]                \r\n");
      out.write("        });\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // Ekspor halaman Monitoring Rekap ke Excel\r\n");
      ...
      out.write("       \r\n");
      out.write("        // ----------------------------------------------------------------------------\r\n");
      out.write("        // 1C Export ke exel semua data MON daftar\r\n");
      out.write("        // ----------------------------------------------------------------------------\r\n");
      ...
      out.write("                const ss = String(now.getSeconds()).padStart(2, '0');\r\n");
      out.write("                const timestamp = \"Tanggal Download: \" + dd + \"/\" + mm + \"/\" + yyyy + \" \" + hh + \":\" + mi + \":\" + ss;\r\n");
      out.write("                const judul1 = \"MIV REKON DAFTAR\";\r\n");
      out.write("                const judul2 = \"BULAN: \" +  vbln_usulan + \" - KDBANK: \" + vkd_bank + \" - KDDIST: \" + vkd_dist;\r\n");
      out.write("\r\n");
      out.write("                // Susun data untuk Excel\r\n");
      out.write("                const rows = [];\r\n");
      out.write("                // Tambah baris judul dengan format bold\r\n");
      out.write("                rows.push([{ v: judul1, s: { font: { bold: true } } }]);\r\n");
      out.write("                rows.push([{ v: judul2, s: { font: { bold: true } } }]);\r\n");
      out.write("                rows.push([{ v: timestamp, s: { font: { bold: true } } }]);\r\n");
      ...
      out.write("                const filename = \"MIV_REKON_DAFTAR_\" + vbln_usulan + \"_\" + vkd_bank + \"_\" + vkd_dist + \".xlsx\";\r\n");
